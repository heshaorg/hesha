...
impl SetupIssuerCmd {
    ...
    Your issuer identity has been created!
        ...
        println!(
            "    📍 URL: https://{}/.well-known/hesha/pubkey.json",
        ...
        println!(
            "    💻 HESHA_CONFIG_DIR={} cargo run --bin hesha-issuer-node",
            output_dir.display()
        );
        println!(
            "    Or: CONFIG_PATH={}/config/issuer.toml cargo run --bin hesha-issuer-node\n",
            output_dir.display()
        );
