...
pub fn execute() -> anyhow::Result<()> {
    ...
    println!(
        "1. Generate keypair: {}",
        "hesha keygen -f json > keys.json".dimmed()
    );
    println!(
        "2. Request attestation: {}",
        "hesha attest -i https://issuer.com -p +1234567890 -k keys.json".dimmed()
    );
    ...
    println!(
        "• Documentation: {}",
        "https://github.com/hesha-protocol/hesha".blue()
    );
    println!(
        "• Specification: {}",
        "https://github.com/hesha-protocol/hesha/docs".blue()
    );
    println!();
